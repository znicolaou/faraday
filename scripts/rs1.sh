...
#MSUB -j oe
#MSUB -V
#MSUB -o "$HOME/faraday/outs/rs1_$MOAB_JOBARRAYINDEX.out"
cd $HOME/faraday/
source activate fenics_env

ZGN_filebase=$HOME/faraday/rs1
