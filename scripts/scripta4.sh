...
#MSUB -j oe
#MSUB -V
#MSUB -o "$HOME/faraday/outs/sa4_$MOAB_JOBARRAYINDEX.out"
cd $HOME/faraday/
source activate fenics_env

ZGN_filebase=$HOME/faraday/sa4
...
#ZGN_A=`bc -l <<<"${ZGN_A0}+(${ZGN_A1}-${ZGN_A0})*${ZGN_temp1}*1.0/${ZGN_N1}"`
ZGN_samp=`bc -l <<<"${ZGN_samp0}+(${ZGN_samp1}-${ZGN_samp0})*${ZGN_temp1}*1.0/${ZGN_N1}"`
ZGN_freq=`bc -l <<<"${ZGN_freq0}+(${ZGN_freq1}-${ZGN_freq0})*${ZGN_temp2}*1.0/${ZGN_N2}"`
